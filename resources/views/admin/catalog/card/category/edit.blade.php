...
<div class="content">
    <div class="block">
        <div class="block-content">
            {!! Form::open(array('url' => URL::route("$base_route.store", $row->id), 'method' => 'post', 'class' => 'form-horizontal', 
                ...
                <div class="form-group {{ $errors->has('category_name') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('category_name', $row->name, array('class' => 'form-control', 
                ...
                <div class="form-group {{ $errors->has('category_text') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('category_text', $row->text, array('class' => 'form-control', 
