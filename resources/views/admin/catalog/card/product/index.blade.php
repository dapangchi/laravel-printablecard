            ...
            <div class="">
                ...
                <thead>
                    <tr>
                        ...
                        {!! sort_th_with_route("$base_route.list", 'Category', 'category', 'left') !!}  
                        {!! sort_th_with_route("$base_route.list", 'Slug', 'slug', 'left') !!}  
                        {!! sort_th_with_route("$base_route.list", 'Created', 'created_at', 'center') !!}  
                        {!! sort_th_with_route("$base_route.list", 'Pricing', 'pricing', 'center') !!}  
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $r->name }}</td>
                        <td>@if(isset($r->category->name)) {{ $r->category->name }} @endif</td>
                        <td>{{ $r->slug }}</td>
                        <td class="text-center">{{ date('Y-m-d H:i', strtotime($r->created_at)) }}</td>
                        <td class="text-center">
                            @if($r->pricing == STATUS_ACTIVE) Yes
                            @else No
                            @endif
                        </td>
                        <td class="text-center">
...
@section('additional')
<script>
warningText = 'Templates(based this card) will be removed. You will not be able to restore this!';
</script>
@stop
