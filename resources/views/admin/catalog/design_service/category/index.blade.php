...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right">
            <a class="btn btn-primary" href='{{ URL::route("admin.design.category.create") }}'>Add</a>    
        </div>
        @endif
    </div>  
</div>
            ...
            <div class="">
                ...
                <thead>
                    <tr>
                        ...
                        {!! sort_th_with_route($list_route, 'Slug', 'slug', 'left') !!}  
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="">
                                <a class="btn btn-sm btn-default btn_edit" href='{{ URL::route("admin.design.category.edit", $r->id) }}'><i class="fa fa-pencil"></i></a>
                                
                                @if($current_user->has_permission('product.design.manage'))
                                <button data-original-title="Remove" class="btn btn-sm btn-warning btn-delete" type="button" data-href='{{ URL::route("admin.design.category.delete", $r->id) }}'><i class="fa fa-times"></i></button>
                                @endif
                            </div>
                        </td>
                    </tr>
