...
<div class="content">
    ...
    {!! Form::open(array('url' => URL::route("admin.design.product.store", $row->id), 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off', 'files' => true)) !!}
    ...
    <div class="block">
        <div class="block-content">    
            ...
            <div class="form-group {{ $errors->has('package-category') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::select('package-category', $categories, $row->design_id, array('class' => 'form-control', 
            ...
            <div class="form-group {{ $errors->has('package-name') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::text('package-name', $row->name, array('class' => 'form-control', 
            ...
            <div class="form-group {{ $errors->has('package-price') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::text('package-price', $row->price, array('class' => 'form-control', 
            ...
            <div class="form-group {{ $errors->has('package-description') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::textarea('package-description', $row->description, array('class' => 'form-control', 
