...
<div class="content">
    ...
    {!! Form::hidden("template_id", $row->id, array('id' => 'template_id')) !!}
        ...
        <div class="block-content">            
            <div class="form-buttons" style="padding-bottom: 20px;">
                <div class="text-right col-xs-offset-2">
                    ...
                    @if($current_user->has_permission('product.template.manage'))
    ...
    <div class="block">
        <div class="block-content">                 
            ...
            <div id="card-option-box">
                @include('admin.catalog.template.product.options', array('template_id' => $row->id, 'card' => $row->card))
            </div>
    ...
    <div class="block">
        <div class="block-content">    
            ...
            <div class="form-group {{ $errors->has('template_name') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::text('template_name', $row->name, array('class' => 'form-control', 
            ...
            <div class="form-group {{ $errors->has('template_description') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::textarea('template_description', $row->description, array('class' => 'form-control', 
