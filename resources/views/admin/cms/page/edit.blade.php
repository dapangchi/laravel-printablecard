...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Page - Edit</h1>
        </div>
    </div>  
</div>
<!-- END Page Header -->
...
<div class="content">
    <div class="block">             
        <div class="block-content">
            {!! Form::open(array('url' => URL::route("admin.cms.page.store", $row->id), 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')) !!}                
                ...
                <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-9">
                        {!! Form::textarea('content', $row->content(), array('class' => 'form-control', 
