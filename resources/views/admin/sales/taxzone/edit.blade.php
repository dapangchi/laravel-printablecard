...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Taxzone - Edit</h1>
        </div>
    </div>  
</div>
<!-- END Page Header -->
...
<div class="content">
    ...
    <div class="block">
        <div class="block-content">
            ...
            {!! Form::open(array('url' => URL::route("admin.sales.taxzone.store", $row->id), 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'aform')) !!}
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="country">Country</label>
                    <div class="col-sm-9">
                        {!! Form::select('country', $countries, $row->country_id, array('class' => 'form-control autowidth', 'id' => 'country', 'required')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {!! Form::select('region', $regions, $row->region_id, array('class' => 'form-control autowidth', 'id' => 'region', 'required')) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::text('tax', $row->tax, array('class' => 'form-control', 'id' => 'tax', 'placeholder' => '', 'required')) !!}
                    </div>
                </div>
