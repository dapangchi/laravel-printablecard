...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Coupons - Create</h1>
        </div>
    </div>  
</div>
<!-- END Page Header -->
    ...
    <div class="block">
        <div class="block-content">
            {!! Form::open(array('url' => URL::route('admin.sales.coupon.store'), 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')) !!}
                {!! Form::hidden('coupon-id', '', array('id' => 'coupon-id')) !!} 
                ...
                <div class="form-group {{ $errors->has('coupon-name') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('coupon-name', null, array('class' => 'form-control', 'id' => 'coupon-name', 'required')) !!}
                ...
                <div class="form-group {{ $errors->has('coupon-code') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('coupon-code', null, array('class' => 'form-control', 'id' => 'coupon-code', 'required')) !!}
                ...
                <div class="form-group {{ $errors->has('discount-percent') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('discount-percent', 0, array('class' => 'form-control', 'id' => 'discount-percent')) !!}
                ...
                <div class="form-group {{ $errors->has('start-date') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('start-date', null, array('class' => 'form-control datepicker', 'id' => 'start-date')) !!}
                ...
                <div class="form-group {{ $errors->has('end-date') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('end-date', null, array('class' => 'form-control datepicker', 'id' => 'end-date')) !!}
                ...
                <div class="form-group {{ $errors->has('limit-time') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('limit-time', 0, array('class' => 'form-control', 'id' => 'limit-time')) !!}
                        <span>0: Unlimit</span>
