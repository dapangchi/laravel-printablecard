...
<div class="content">
    ...
    <div class="block">
        <div class="block-content">
            {!! Form::open(array('url' => URL::route('admin.permission.store'), 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')) !!}
                ...
                <div class="form-group {{ $errors->has('permission-code') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('permission-code', null, array('class' => 'form-control', 
                            'id' => 'permission-code', 'placeholder' => '', 'required', 'autofocus')) !!}
                    </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('permission-name') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::text('permission-name', null, array('class' => 'form-control', 
                ...
                <div class="form-group {{ $errors->has('permission-description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        {!! Form::textarea('permission-description', null, array('class' => 'form-control', 
