...
<div class="content pulldown text-muted text-center">
    ...
    <a class="link-effect" href="#">Report it</a> or <a class="link-effect" href="{{ admin_url('dashboard') }}">Go Back to Dashboard</a>
</div>
<!-- END Error Footer -->

<!-- OneUI Core JS: jQuery, Bootstrap, slimScroll, scrollLock, Appear, CountTo, Placeholder, Cookie and App.js -->
<script src="{{ asset('admins/js/oneui.min.js') }}"></script>
