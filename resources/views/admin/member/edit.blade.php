...
<div class="content bg-gray-lighter">
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">Members - Edit [ {{ $row->full_name() }} ]</h1>
        </div>
    </div>  
</div>
<!-- END Page Header -->
...
<div class="content">
    ...
    <div class="block">
        <div class="block-content">
            {!! Form::open(array('url' => URL::route("admin.member.store"), 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')) !!}
                {!! Form::hidden('user_id', $row->id, array('id' => 'user_id')) !!} 
                
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="first_name">First Name<span class="red">*</span></label>
                    <div class="col-sm-7">
                        {!! Form::text('first_name', $row->first_name, array('class' => 'form-control', 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! Form::email('email', $row->email, array('class' => 'form-control', 
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="is_active">User Type</label>
                    <div class="col-sm-7">
                        {!! Form::select('user_type', ['1' => 'Staff', '0' => 'Administrator'], $row->user_type, array('class' => 'form-control', 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! Form::select('is_active', ['1' => 'Active', '0' => 'InActive'], $row->is_active, array('class' => 'form-control', 
...
$('#aform').validate({
    ...
    rules: {
        ...
        'email': {
            ...
            email: true,
            remote: {
                url: '{{ URL::route("admin.member.ajax.check.email") }}',
                type: 'post',
                data: {
