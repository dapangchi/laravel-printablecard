<li class="{{ $ft->is_print == YES ? 'print-feature' : '' }}">
    ...
    <div class="card-options-sub-menu">
        @if($ft->link != '')
        <a class="open-popup-link" href="{{ $ft->link != '' }}" title="To learn more about {{ $ft->name }}, please visit our feature gallery" target="_blank">
            <i class="fa fa-question-circle info-icon"></i>
        </a>
        @else
        <a class="open-popup-link1" title="To learn more about {{ $ft->name }}, please visit our feature gallery" target="_blank">
            <i class="fa fa-question-circle info-icon"></i>
        </a>
        @endif
