            ...
            <div class="det-ord-bl">
                ...
                <div class="det-ord-cont">
                    {!! Form::open(array('url' => $product->getUploadUrl(), 'id' => 'product-form', 'method' => 'post')) !!}
                        ...
                        <div id="option-list-box">
                            @include('frontend.catalog.card.product.options', array('product' => $product, 'quantityId' => $quantityId))
                        </div>
                        ...
                        <button type="submit" id="btn-buy-now">Buy Now</button>
...
@include('frontend.catalog.card.product.bubbles', array('images' => $product->images))
...
<script>
ajaxUpdatePriceURL = "{{ URL::route('card.product.update.price') }}";
</script>
