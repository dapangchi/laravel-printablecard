...
$icons = array('Luxury <br>Business Cards', 'Premium <br>Business Cards', 'Plastic <br>Business Cards',
    'Quick <br>Business Cards', 'Classic <br>Business Cards');
?>
    ...
    <div class="full-window-section">
        <div class="swiper-container sample-package-slider">
            <div class="swiper-wrapper">
                <?php for($i=1; $i<=17; $i++) { ?>
                <div class="swiper-slide"><img src='{{ upload_url("samplepack/sample-pack-img$i.jpg") }}' alt="business card sample 1"></div>
                <?php } ?>
            </div>
